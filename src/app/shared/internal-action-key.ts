export class InternalActionKeys {
    ...
    static readonly deudasCliente = 'deudas_cliente';
    ...
    static readonly openCashDrawer = 'openCashDrawer';
    static readonly anulacionParcial = 'anulacion_parcial';
    static readonly abrirCajon = 'abrir_cajon';
    static readonly closeApp = 'closeapp';
    static readonly informeVentas = 'informes_ventas';
    static readonly gradesChangePrices = 'grades_change_prices';
    static readonly copyLastTicket = 'copia_ultimo_ticket';
}
